...
.factory('blogService', function($resource, $q) {
      ...
      service.createBlog = function(accountId, blogData) {
        var Blog = $resource("http://localhost:8080/spring_angularjs/rest/accounts/:paramAccountId/blogs");
        return Blog.save({paramAccountId: accountId}, blogData).$promise;
      };
      service.getAllBlogs = function() {
        var Blog = $resource("http://localhost:8080/spring_angularjs/rest/blogs");
      ...
      service.getBlogsForAccount = function(accountId) {
          ...
          var Account = $resource("http://localhost:8080/spring_angularjs/rest/accounts/:paramAccountId");
